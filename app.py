...
loan_type = st.radio("Select Loan Type:", ["Personal Loan", "Housing Loan"])
...
if loan_type == "Personal Loan":
    ...
    if submit_button:
        ...
        user_input = pd.get_dummies(user_input, columns=["PROPERTY_TYPE", "CONSTRUCTION_STATUS"], drop_first=True)
